...
access and use data to improve public health and ahelp with common string manipulation tasks
...
`str_rip` will rip (split) a string `string` (or vector of strings) by a simple separator.
...
It returns a character matrix with columns for each split of the input string
